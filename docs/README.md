...
| `bcbs239-policy-design.md` | How BCBS 239 should exist as Alation **policies and CDE standards** — four policies rather than one or eleven, the attestation fields each CDE must answer, creation ordering, and what to verify before automating it |
